def naming():
    ...
    for i in a:
        for j in b:
            for k in c:
                for l in range(1, 4):
                    out.append('    "equipment_' + str(n) + '": {"type": "material", "id": "equipment_' + str(n) + '", "name": "' + str(i + j[0] + k + j[l]) + '", "price": 10000, "decoration": 2},')
                    n += 1
...
def price():
    ...
    type_coefficients_0 = {"戰甲": 9, "戰靴": 4, "劍": 8, "騎甲": 10, "騎靴": 5, "槍": 7, "布甲": 3, "布靴": 2, "弓": 6, "皮甲": 4, "皮靴": 3, "匕": 1, "聖袍": 8, "聖靴": 4, "經": 7, "法袍": 9, "法靴": 5, "杖": 6, "重甲": 10, "重靴": 5, "盾": 8, "巫袍": 7, "巫靴": 3, "符": 2}
